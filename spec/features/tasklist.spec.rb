...
feature 'タスク管理機能', type: :feature do
  background do
    ...
    FactoryBot.create(:task, title:'one', content: 'testcontent', limit_datetime: '20181201')
    FactoryBot.create(:task, title:'two', content: 'testcontent', limit_datetime: '20181215')
    FactoryBot.create(:task, title:'three', content: 'testcontent', limit_datetime: '20181220')
  end
